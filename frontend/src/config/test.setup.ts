...
;(globalThis as Record<string, unknown>).SERVER_VARIABLES = {
  ...
  apiURL: { base: 'http://localhost/wp-json/SEOChangeMonitor/v1', separator: '?' },
  assetsURL: '',
  dateFormat: 'F j, Y',
  nonce: 'test-nonce',
  pluginAdminURL: 'http://localhost/wp-admin/admin.php?page=seo-change-monitor#',
  pluginSlug: 'seo-change-monitor',
